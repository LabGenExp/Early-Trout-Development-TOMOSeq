  ...
  HTML("
    <div style='background-color:#f8f9fa; border-left: 6px solid #5bc0de; padding: 15px; border-radius: 6px; font-size: 14px;'>
      ...
      <ul>
        ...
        <li><b>Metadata:</b> Explore comparative summaries of expression features for each species. If a gene is listed with a profile it is differentially localized with fold change >2x (rainbow trout/hybrid trout) or >1.5x (zebrafish).</li>
      </ul>
...
<p>Trout hybrid: Genome1 = <i>O. mykiss</i>;   Genome2 = <i>Salvelinus fontinalis</i>.</p>
      <p>This tool complements the publication <i>“RNA redistribution driven by alterations in transcription during early embryogenesis of rainbow trout”</i> (Journal, YYYY), enabling interactive visualization of gene abundance dynamics during embryogenesis.</p>
    </div>
  ")
})
```
